      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 pb-12 border-b border-white/10">
          ...
          <div>
            ...
            <div className="mt-5 p-4 bg-white/10 rounded-2xl border border-white/15 max-w-xs">
              <p className="text-xs text-white font-medium mb-2">Reach thousands of student leads</p>
              <Link
                href="/role-select"
          ...
          <div>
            ...
            <div className="mt-6">
              <p className="text-xs text-white mb-2 font-medium">Get Campus Housing Updates</p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-8 text-xs text-[#CBD5E1] text-center sm:text-left">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            <a href="#" className="text-[#E2E8F0] hover:text-white transition-colors">Privacy Policy</a>
            <span>•</span>
            <a href="#" className="text-[#E2E8F0] hover:text-white transition-colors">Terms of Service</a>
            <span>•</span>
            <a href="#" className="text-[#E2E8F0] hover:text-white transition-colors">Safety Standards</a>
          </div>
        </div>
      </div>
    </footer>
