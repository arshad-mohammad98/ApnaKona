...
export default function Logo({
  ...
  // Colors
  const primaryColor = mono ? "currentColor" : "#234C60";
  const accentColor = mono ? "currentColor" : "#F09A57";
  const textColorPrimary = theme === "dark" ? "text-white" : "text-[#0D212D] dark:text-white";
  const textColorAccent = "text-[#F09A57]";
  ...
  const IconSVG = (
    ...
    >
      ...
      <rect
        ...
        height="40"
        rx="12"
        fill={theme === "dark" ? "rgba(255, 255, 255, 0.08)" : "#E5EFF4"}
      />
