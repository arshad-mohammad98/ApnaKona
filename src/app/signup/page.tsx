      ...
      <div className="w-full max-w-md mx-auto">
        <div className="bg-white dark:bg-slate-800/95 rounded-3xl shadow-card border border-[#E2E8F0] dark:border-slate-700/80 p-6 sm:p-8">
          ...
          <p className="text-[#334155] dark:text-slate-300 text-xs sm:text-sm mb-6">
            Join ApnaKona as a {role === "owner" ? "Property Owner" : "User"}
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              ...
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 py-3 px-4 bg-[#F4A261] hover:bg-[#e7924e] text-white font-bold rounded-xl transition-colors disabled:opacity-60 min-h-[46px] cursor-pointer shadow-sm shadow-[#F4A261]/25"
            >
              {loading ? (
