        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-3 mb-2.5">
            ...
            <h1 className="font-display text-2xl sm:text-3xl font-bold">
              Find Verified <span className="text-[#F09A57]">Roommates</span>
            </h1>
          </div>
          ...
          <div className="mt-6 flex items-center gap-3 bg-white/15 border border-white/25 rounded-2xl px-4 py-2.5 max-w-xl backdrop-blur-xs">
            ...
            <input
              ...
              className="flex-1 bg-transparent text-white placeholder-white/70 outline-none text-xs sm:text-sm min-h-[38px] font-medium"
            />
          </div>
        </div>
      </div>
