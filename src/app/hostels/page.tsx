        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <h1 className="font-display text-2xl sm:text-3xl lg:text-4xl font-bold mb-2 text-white">
              Find Student <span className="text-[#F09A57]">Hostels, PGs &amp; Flats</span>
            </h1>
            ...
            <div className="flex flex-wrap items-center gap-1.5 mt-4 text-xs">
              <span className="text-white/80 font-semibold">Quick Cities:</span>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto justify-between sm:justify-end">
            ...
            {/* Sort Dropdown */}
            <div className="flex items-center gap-2">
              <span className="text-xs text-gray-500 dark:text-slate-400 hidden sm:inline font-medium">Sort by:</span>
              <div className="relative">
                <select
                  value={sort}
