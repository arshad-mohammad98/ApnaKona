  ...
  return (
    <div className="min-h-screen bg-[#F9FAFB] pb-16">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        {/* Tab: Chats */}
        {activeTab === "chats" && (
          <div key="chats" className="space-y-4 tab-pane-transition">
              ...
              >
                <div className="min-w-0 flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    <span className="font-bold text-sm sm:text-base text-gray-900 dark:text-white">{c.owner}</span>
                    {c.unread && (
                      <span className="bg-red-500 text-white text-[10px] font-bold px-2 py-0.5 rounded-full">
                        New
                      </span>
                    )}
                    <span className="text-xs text-gray-400 dark:text-slate-500 ml-auto sm:ml-0">{c.time}</span>
                  </div>
                  <p className="text-xs font-semibold text-[#0F4C81] dark:text-sky-400 mb-1">{c.listing}</p>
                  <p className="text-xs sm:text-sm text-gray-600 dark:text-slate-300 truncate">{c.lastMsg}</p>
                </div>
                <button className="w-full sm:w-auto px-4 py-2.5 bg-[#0F4C81] hover:bg-[#0d3f6e] dark:bg-blue-600 dark:hover:bg-blue-500 text-white rounded-xl text-xs sm:text-sm font-semibold cursor-pointer shrink-0 min-h-[40px]">
                  Open Conversation
                </button>
              </div>
            ))}
        ...
        {/* Tab: Profile */}
        {activeTab === "profile" && (
          <div key="profile" className="bg-white dark:bg-[#131D31] rounded-3xl p-5 sm:p-8 shadow-card border border-gray-100 dark:border-slate-800 max-w-2xl tab-pane-transition">
