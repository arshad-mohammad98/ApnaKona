        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="font-display text-2xl sm:text-3xl font-bold">
              Grievance &amp; <span className="text-[#F09A57]">Redressal</span>
            </h1>
          </div>
        ...
        {tab === "listing" && (
          <div key="listing" className="bg-white dark:bg-[#131D31] rounded-3xl shadow-card border border-gray-100 dark:border-slate-800 p-5 sm:p-8 tab-pane-transition">
            ...
            <form onSubmit={handleListingSubmit} className="space-y-4 sm:space-y-5">
              ...
              <button
                type="submit"
                className="w-full flex items-center justify-center gap-2 py-3.5 px-6 bg-[#2A556A] hover:bg-[#214557] text-white font-bold rounded-xl text-xs sm:text-sm transition-colors min-h-[46px] cursor-pointer shadow-sm shadow-[#2A556A]/20"
              >
